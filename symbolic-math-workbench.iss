...
Source: "{#SourceDir}\themes\*"; DestDir: "{app}\themes"; Components: app; Flags: ignoreversion recursesubdirs
Source: "{#SourceDir}\assets\*"; DestDir: "{app}\assets"; Components: app; Flags: ignoreversion recursesubdirs

; REDUCE CAS binaries (from tools/reduce)
Source: "..\tools\reduce\bin\*"; DestDir: "{app}\reduce\bin"; Components: app; Flags: ignoreversion recursesubdirs
Source: "..\tools\reduce\lib\*"; DestDir: "{app}\reduce\lib"; Components: app; Flags: ignoreversion recursesubdirs

; Godot executable (from tools/godot)
Source: "..\tools\godot\Godot_v4.6.3-stable_win64.exe"; DestDir: "{app}\bin"; DestName: "Godot.exe"; Components: app; Flags: ignoreversion
...
Source: "..\task*.md"; DestDir: "{app}\docs\tasks"; Components: docs; Flags: ignoreversion recursesubdirs
...
begin
  WizardForm.WelcomeLabel1.Caption := '{#MyAppName} {#MyAppVersion}';
  WizardForm.WelcomeLabel2.Caption :=
    'This will install Symbolic Math Workbench, a Godot-based computer algebra system interface to REDUCE CAS.' + #13#13 +
    'The installer includes:' + #13 +
    '  • Godot 4.6.3 runtime' + #13 +
    '  • REDUCE computer algebra system' + #13 +
    '  • Sample notebooks and documentation' + #13#13 +
    'Click Next to continue.';
end;

procedure CurStepChanged(CurStep: TSetupStep);
begin
  if CurStep = ssInstalling then
    WizardForm.StatusLabel.Caption := 'Installing Symbolic Math Workbench...'
  else if CurStep = ssFinished then
