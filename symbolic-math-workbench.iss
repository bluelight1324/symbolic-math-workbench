...
; EXCLUDE: .godot cache folder (must be regenerated by Godot in new location)
; The stale .godot folder prevents proper class registration and autoload initialization
; It will be regenerated automatically when the app first runs
...
[InstallDelete]
; Clean up old cache to force Godot to regenerate on first run
Type: dirifempty; Name: "{app}\.godot"
